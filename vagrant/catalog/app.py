...
def show_category(topic_url, category_url):
    ...
    return render_template('category.html', category=category,
                           articles=articles, topic_url=topic_url)


@app.route('/topics/<topic_url>/categories/<category_url>/new/',
           methods=['GET', 'POST'])
def create_article(topic_url, category_url):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('show_category',
                        topic_url=topic_url, category_url=category_url))
    else:
...
@app.route('/topics/<topic_url>/categories/<category_url>/<article_id>/edit/',
           methods=['GET', 'POST'])
def edit_article(topic_url, category_url, article_id):
    ...
    if article.user_id != login_session['user_id']:
        flash('You are not the authorized to edit this article. ' +
              'Please select an article you\'ve created in order to edit')
        return redirect(url_for('show_article', topic_url=topic_url,
                        category_url=category_url, article_id=article_id))
    if request.method == 'POST':
        ...
        return render_template('edit_article.html', topic_url=topic_url,
                               category_url=category_url,
...
def delete_article(topic_url, category_url, article_id):
    ...
    if 'username' not in login_session:
        return redirect('/login')
    if article.user_id != login_session['user_id']:
        flash('You are not the authorized to delete this article. ' +
              'Please select an article you\'ve created in order to delete it')
        return redirect(url_for('show_article', topic_url=topic_url,
                        category_url=category_url, article_id=article_id))
    if request.method == 'POST':
        ...
        return render_template('delete_article.html', topic_url=topic_url,
                               category_url=category_url,
                               article_id=article_id,
                               article=article)
