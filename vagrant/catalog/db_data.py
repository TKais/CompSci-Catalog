...
supervised_learning = Category(name='Supervised Learning', topic_id=1)
session.add(supervised_learning)
session.commit()

unsupervised_learning = Category(name='Unsupervised Learning', topic_id=1)
...
augmented_reality = Category(name='Augmented Reality', topic_id=2)
...
relational_model = Category(name='Relational Model', topic_id=3)
...
python = Category(name='Python', topic_id=4)
session.add(python)
session.commit()
...
communication_networks = Category(name='Communication Networks', topic_id=5)
...
testing = Category(name='Testing', topic_id=6)
session.add(testing)
session.commit()
...
computer_vision = Category(name='Computer Vision', topic_id=7)
...
differential_equations = Category(name='Differential Equations', topic_id=8)
...
computational_complexity_theory = Category(name='Computational Complexity Theory', topic_id=9)
...
DNA_sequencing = Category(name='DNA sequencing', topic_id=10)
