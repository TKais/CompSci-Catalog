...
augmented_reality = Category(name='Augmented Reality',
...
relational_model = Category(name='Relational Model',
                            url='Relational-Model',
                            topic_id=3,
...
computer_systems_networks = Topic(name='Computer Systems and Networks',
                                  url='Computer-Systems-Networks',
                                  image='networks.jpg')
session.add(computer_systems_networks)
session.commit()

communication_networks = Category(name='Communication Networks',
                                  url='Communication-Networks',
                                  topic_id=5,
                                  image='comm-networks.jpg')
...
testing = Category(name='Testing', url='Testing',
                   topic_id=6, image='testing.png')
session.add(testing)
session.commit()

vision_graphics = Topic(name='Vision and Graphics',
                        url='Vision-and-Graphics', image='vision.jpg')
session.add(vision_graphics)
session.commit()

computer_vision = Category(name='Computer Vision',
                           url='Computer-Vision',
                           topic_id=7,
                           image='vision2.jpg')
...
numerical_analysis = Topic(name='Numerical Analysis',
                           url='Numerical-Analysis',
                           image='numerical.jpg')
session.add(numerical_analysis)
session.commit()

differential_equations = Category(name='Differential Equations',
...
computational_complexity = Category(name='Computational Complexity Theory',
                                    url='Computational-Complexity-Theory',
                                    topic_id=9, image='complexity.jpg')
session.add(computational_complexity)
session.commit()
...
DNA_sequencing = Category(name='DNA sequencing',
                          url='DNA-Sequencing',
                          topic_id=10,
                          image='DNA.jpg')
